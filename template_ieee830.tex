...
\pagestyle{fancy}
\author{Ing. Lautaro Juan Bautista Vera}
...
\begin{document}
	\begin{titlepage}
		\centering
		{\scshape\Huge Bootloader Multi-Etapa \par}
		\vspace{5cm}
		{\bfseries\LARGE Especificación de Requerimientos de Software \par}
		\vspace{1cm}
		{\scshape\Large IEEE Std. 830-1998 \par}
		\vfill
		{\Large Ing. Lautaro Juan Bautista Vera \\ (\href{mailto:lautarovera93@gmail.com}{lautarovera93@gmail.com})\par}
		\vfill
